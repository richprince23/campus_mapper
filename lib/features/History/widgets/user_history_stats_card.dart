...
class UserHistoryStatsCard extends StatefulWidget {
  const UserHistoryStatsCard({super.key});

  @override
  State<UserHistoryStatsCard> createState() => _UserHistoryStatsCardState();
}

class _UserHistoryStatsCardState extends State<UserHistoryStatsCard> {
              ...
              AnimatedCrossFade(
                ...
                secondChild: Column(
                  children: [
                    ...
                    const SizedBox(height: 8),
                    // Third row - Distance and Calories (if needed, uncomment)
                    // ...
                  ],
                ),
  ...
  Widget _buildClickableStatItem(
    ...
    return GestureDetector(
      onTap: () {
        ...
        if ((value == '0' || value == '0.0 km' || value == '0 cal') &&
            filterType != 'all' &&
            filterType != 'distance' &&
            filterType != 'calories') {
